		...
		<div class="container">
			...
			<div id="navbar" class="collapse navbar-collapse sidebar-offcanvas">
				...
				<ul class="nav navbar-nav">
					...
					<li class="active"><a
						href="${pageContext.request.contextPath}/news/findNewsList.action?currentPage=0">金融新闻</a></li>
				</ul>
				...
				<div class="starter-template">
					<div class="row">
						<div class="col-lg-5 col-lg-offset-1 col-md-5 col-md-offset-1">
							<h2 class="banner-title" id="jieshao">金融新闻</h2>
							<p class="banner-detail">
								你了解金融吗？<br /> 如果不了解的话，这里可以让您对金融知识丰富起来<br />
								如果已经了解过的话，这里也可以让您增加对金融的认识<br /> 行动起来吧，欢迎来到金融天地
							</p>
						</div>
